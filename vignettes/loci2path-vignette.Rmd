...
In order to build gene set, we also need to know the total number of genes in order to perform enrichment test. In this study, the total number of gene in MSigDB pathway collection is 31,847 (ref) 
```{r}
#build geneSet
biocarta=geneSet(
  gene.set=set.geneid,
